        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-8 space-y-12">
            <header className="space-y-4">
              <h2 className="text-5xl font-black tracking-tight uppercase">ARENA PROGRESS</h2>
              <p className="text-xl text-gray-500 max-w-2xl">Your journey through the decentralized mind. Progress by proving your mastery to the Guardians.</p>
            </header>
                ...
                return (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-6 mb-8">
                      <div className="flex items-center gap-8">
                        <div className={`w-14 h-14 rounded-full flex items-center justify-center border-2 border-primary/20 ${
                            isCompleted ? 'bg-success/10 border-success text-success' : 
                            isCurrent ? 'bg-primary/20 border-primary text-primary' : 
                            'text-gray-600'
                          }`}>
                          {isCompleted ? <Unlock size={24} /> : (isUnlocked ? <Unlock size={24} /> : <Lock size={24} />)}
                        </div>
                        <div>
                    ...
                    {isUnlocked ? (
                      <div className="space-y-8">
                        <p className="text-gray-400 text-xl font-light italic leading-relaxed">"{level.description}"</p>
                        <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-4">
                          <p className="text-white text-2xl font-bold leading-snug">{level.content}</p>
                        </div>
                        <div className="flex flex-wrap gap-6 items-center pt-4">
                           <TaskView levelTitle={level.title} gistUrl={level.link} />
                           {isCurrent && (
                             <span className="text-gray-500 text-xs uppercase font-black tracking-widest border border-white/10 px-6 py-3 rounded-xl bg-white/5">
          ...
          <aside className="lg:col-span-4 space-y-8 lg:sticky lg:top-40">
            <div className="glass p-12 text-center border-primary/20 bg-primary/5">
               <h2 className="text-2xl font-black uppercase tracking-widest mb-12">BADGE ARCHIVE</h2>
